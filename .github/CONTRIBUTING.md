...
0. **创建 Issue**：通过 [GitHub Issues](hhttps://github.com/SlimeBoyOwO/LingChat/issues) 创建一个新的 Issue，使用 **功能请求模板** 详细描述你的想法、使用场景以及它能解决什么问题。
1. **社区讨论**：我们会与你和其他社区成员一同讨论该功能的可行性和具体实现。
2. **达成共识**：只有在社区达成共识后，才建议开始投入代码开发。
