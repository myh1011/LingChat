...
export default {
  ...
  toolCalls: {
    ...
    fileDeleteAutoApprove: "Delete without confirmation (including detected delete commands)",
    fileDeleteAutoApproveHint: "⚠ Dangerous! Files and detected del, Remove-Item, rm, and similar commands can run without confirmation",
    ...
    commandAutoApproveHint: "⚠ Dangerous! Commands can run without consent; detected delete commands are still controlled by “Delete without confirmation”",
