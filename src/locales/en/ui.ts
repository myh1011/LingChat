...
export default {
  ...
  toolCalls: {
    ...
    fileDeleteAutoApprove: "Delete files without confirmation (no popup)",
    ...
    commandAutoApproveHint: "⚠ Dangerous! They can run any command without your consent. Enable with care",
